...
Use the [GitHub Security Advisory](https://github.com/ktestify/ktestify-plugin-http/security/advisories/new)
...
Send a detailed report to the maintainers at [security@ktestify.xyz](mailto:security@ktestify.xyz).
Include:
...
This policy applies to the `ktestify-plugin-http` library and its direct dependencies.
